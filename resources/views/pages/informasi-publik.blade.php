...
<section class="py-10 lg:py-14">
    ...
    {{-- ── BERITA ───────────────────────────────────────────────────────── --}}
    <div id="panel-berita" class="panel-section max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {{-- ── PENGUMUMAN ───────────────────────────────────────────────────── --}}
    <div id="panel-pengumuman" class="panel-section hidden max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
